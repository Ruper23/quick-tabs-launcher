...
- One-click START opens all active tabs in the default browser
- Rename, toggle active/inactive, delete, refresh favicon
- 10 built-in color themes with application-wide background support
- Frameless custom titlebar with a fast, distraction-free UI
...
- Works offline for tab management; opens links in the default browser
